...
namespace CoreData.Core
{
    public static class EntityExtension
    {
        ...
        public static T AutoMapIgnoreId<T, TPrimaryKey>(this T source)
            where T : PrimaryAggregateEntity<TPrimaryKey>, new()
        {
    ...
    public static class MongoEntityExtension
    {
        ...
        /// <returns></returns>
        public static IEnumerable<T> Clone<T>(this IEnumerable<T> source, bool deep = false)
