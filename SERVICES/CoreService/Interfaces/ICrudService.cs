...
namespace CoreService.Interfaces
{
    ...
    public interface ICrudService<T> : IService where T : AggregateRoot
    {
        ...
        /// <returns></returns>
        Task<T> CreateAsync<TModel>(string orgId, TModel addModel, Func<T, bool> createHook = null)
        ...
        /// <returns></returns>
        Task<T> UpdateAsync<TModel>(TModel updateModel, Func<T, bool> updateHook = null)
