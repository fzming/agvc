...
namespace AgvcService.Users.Models
{
    public class AuthorizedUser
    {
        ...
        {
            if (Principal == null) throw new Exception($"GetArray {claimType} Principal is null");
        ...
        {
            if (Principal == null) throw new Exception($"GetString {claimType} Principal is null");
            var claimsIdentity = Principal.Identity as ClaimsIdentity;
        ...
        {
            if (tag.StartsWith("zl-")) return HasAuthorityCode(tag);
