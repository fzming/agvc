...
namespace AgvcService.Users
{
    ...
    public interface IAccountBalanceService : IService
    {
        ...
        Task<PageResult<AccountBalance>> QueryBalanceLogsAsync(string clientId, BalanceType balanceType,
        ...
        /// <returns></returns>
        Task<IEnumerable<AccountBalance>> QueryIncomeSourceAsync(string clientId, BalanceType balanceType,
