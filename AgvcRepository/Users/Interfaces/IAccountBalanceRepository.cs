...
namespace AgvcRepository.Users.Interfaces
{
    public interface IAccountBalanceRepository : IRepository<AccountBalance>
    {
        ...
        Task<PageResult<AccountBalance>> AdvanceQueryAsync(string clientId, BalanceType balanceType, int paymentType,
            DateTime? btm, DateTime? etm, int pageSize, int pageIndex);
        ...
        Task<bool> IncomeBalanceAsync(string userid, double balanceValue, BalanceType balanceType,
            IncomeSourceType incomeSourceType = IncomeSourceType.None, string incomeUniqueKey = "",
